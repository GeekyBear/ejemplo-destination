		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ejemplodestinatiom-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ejemplodestinatiom-display": {
								"semanticObject": "ejemplodestinatiom",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ejemplodestinatiom",
									"url": sap.ui.require.toUrl("ejemplodestinatiom")
								}
							}
						}
					}
